package com.umc.footprint.src.auth;
...
import com.umc.footprint.src.auth.model.AuthReqModel;
...
public class AuthController {
    ...
    public ApiResponse login(
        ...
        UserRefreshToken userRefreshToken = userRefreshTokenRepository.findByOauthId(userId);
    ...
    public ApiResponse refreshToken (HttpServletRequest request, HttpServletResponse response) {
        ...
        // userId refresh token 으로 DB 확인
        UserRefreshToken userRefreshToken = userRefreshTokenRepository.findByOauthIdAndAndRefreshToken(userId, refreshToken);
        if (userRefreshToken == null) {
            return ApiResponse.invalidRefreshToken();
        }
