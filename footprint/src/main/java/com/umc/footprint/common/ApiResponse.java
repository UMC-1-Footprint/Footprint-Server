package com.umc.footprint.common;
...
public class ApiResponse<T> {
    ...
    private final static String INVALID_ACCESStOKEN = "Invalid access token.";
    ...
    public static <T> ApiResponse<T> invalidAccessToken() {
        return new ApiResponse(new ApiResponseHeader(FAILED, INVALID_ACCESStOKEN), null);
    }
